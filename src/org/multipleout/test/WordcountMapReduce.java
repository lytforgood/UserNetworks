...
public class WordcountMapReduce extends Configured implements Tool {
	...
	public static class WordcountReducer extends
		...
		protected void reduce(Text key, Iterable<IntWritable> values,
			...
			mo.write("test",key, result);
			//write(Text key,IntWritable value,String baseOutputPath) 
			//write(String namedOutput,Text key,IntWritable value) 
			//write(String namedOutput,Text key,Object value,String baseOutputPath) 
			//Random random = new Random();   来生成文件名   
			//long test = random.nextInt(100); 来生成文件名。
		}
	...
	public int run(String[] args) throws Exception {
		...
		//MultipleOutputs.addNamedOutput(job, "test2",TextOutputFormat.class, Text.class, IntWritable.class);
	...
	public static void main(String[] args) throws Exception {
		args = new String[] {
				...
				"hdfs://hadoop-00:9000/home910/liyuting/outpuwordoutput2/" };
		// run mapreduce
